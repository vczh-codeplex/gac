...
***********************************************************************/
	...
	namespace function_type_retriver
	{
		template<typename T>
		struct Retriver
		{
...
/***********************************************************************
vl::function_type_retriver::Retriver for R()
***********************************************************************/
		template<typename R >
		struct Retriver<R(*)()>
		{
		...
		template<typename R >
		struct Retriver<Func<R()>>
		{
			typedef R Type();
		};
 
		template<typename C ,typename R >
		struct Retriver<R(__thiscall C::*)()>
		{
			typedef R Type();
		};
 
		template<typename C ,typename R >
		struct Retriver<R(__thiscall C::*)()const>
		{
			typedef R Type();
		};
 
/***********************************************************************
vl::function_type_retriver::Retriver for void()
***********************************************************************/
		template< >
		struct Retriver<void(*)()>
		{
			typedef void Type();
		};
 
		template< >
		struct Retriver<Func<void()>>
		{
			typedef void Type();
		};
 
		template<typename C   >
		struct Retriver<void(__thiscall C::*)()>
		{
			typedef void Type();
		};
 
		template<typename C   >
		struct Retriver<void(__thiscall C::*)()const>
		{
			typedef void Type();
		};
  
/***********************************************************************
vl::function_type_retriver::Retriver for R(T0)
***********************************************************************/
		template<typename R,typename T0>
		struct Retriver<R(*)(T0)>
		{
			typedef R Type(T0);
		};
 
		template<typename R,typename T0>
		struct Retriver<Func<R(T0)>>
		{
			typedef R Type(T0);
		};
 
		template<typename C ,typename R,typename T0>
		struct Retriver<R(__thiscall C::*)(T0)>
		{
			typedef R Type(T0);
		};
 
		template<typename C ,typename R,typename T0>
		struct Retriver<R(__thiscall C::*)(T0)const>
		{
			typedef R Type(T0);
		};
 
/***********************************************************************
vl::function_type_retriver::Retriver for void(T0)
***********************************************************************/
		template< typename T0>
		struct Retriver<void(*)(T0)>
		{
			typedef void Type(T0);
		};
 
		template< typename T0>
		struct Retriver<Func<void(T0)>>
		{
			typedef void Type(T0);
		};
 
		template<typename C  ,typename T0>
		struct Retriver<void(__thiscall C::*)(T0)>
		{
			typedef void Type(T0);
		};
 
		template<typename C  ,typename T0>
		struct Retriver<void(__thiscall C::*)(T0)const>
		{
			typedef void Type(T0);
		};
  
/***********************************************************************
vl::function_type_retriver::Retriver for R(T0,T1)
***********************************************************************/
		template<typename R,typename T0,typename T1>
		struct Retriver<R(*)(T0,T1)>
		{
			typedef R Type(T0,T1);
		};
 
		template<typename R,typename T0,typename T1>
		struct Retriver<Func<R(T0,T1)>>
		{
			typedef R Type(T0,T1);
		};
 
		template<typename C ,typename R,typename T0,typename T1>
		struct Retriver<R(__thiscall C::*)(T0,T1)>
		{
			typedef R Type(T0,T1);
		};
 
		template<typename C ,typename R,typename T0,typename T1>
		struct Retriver<R(__thiscall C::*)(T0,T1)const>
		{
			typedef R Type(T0,T1);
		};
 
/***********************************************************************
vl::function_type_retriver::Retriver for void(T0,T1)
***********************************************************************/
		template< typename T0,typename T1>
		struct Retriver<void(*)(T0,T1)>
		{
			typedef void Type(T0,T1);
		};
 
		template< typename T0,typename T1>
		struct Retriver<Func<void(T0,T1)>>
		{
			typedef void Type(T0,T1);
		};
 
		template<typename C  ,typename T0,typename T1>
		struct Retriver<void(__thiscall C::*)(T0,T1)>
		{
			typedef void Type(T0,T1);
		};
 
		template<typename C  ,typename T0,typename T1>
		struct Retriver<void(__thiscall C::*)(T0,T1)const>
		{
			typedef void Type(T0,T1);
		};
  
/***********************************************************************
vl::function_type_retriver::Retriver for R(T0,T1,T2)
***********************************************************************/
		template<typename R,typename T0,typename T1,typename T2>
		struct Retriver<R(*)(T0,T1,T2)>
		{
			typedef R Type(T0,T1,T2);
		};
 
		template<typename R,typename T0,typename T1,typename T2>
		struct Retriver<Func<R(T0,T1,T2)>>
		{
			typedef R Type(T0,T1,T2);
		};
 
		template<typename C ,typename R,typename T0,typename T1,typename T2>
		struct Retriver<R(__thiscall C::*)(T0,T1,T2)>
		{
			typedef R Type(T0,T1,T2);
		};
 
		template<typename C ,typename R,typename T0,typename T1,typename T2>
		struct Retriver<R(__thiscall C::*)(T0,T1,T2)const>
		{
			typedef R Type(T0,T1,T2);
		};
 
/***********************************************************************
vl::function_type_retriver::Retriver for void(T0,T1,T2)
***********************************************************************/
		template< typename T0,typename T1,typename T2>
		struct Retriver<void(*)(T0,T1,T2)>
		{
			typedef void Type(T0,T1,T2);
		};
 
		template< typename T0,typename T1,typename T2>
		struct Retriver<Func<void(T0,T1,T2)>>
		{
			typedef void Type(T0,T1,T2);
		};
 
		template<typename C  ,typename T0,typename T1,typename T2>
		struct Retriver<void(__thiscall C::*)(T0,T1,T2)>
		{
			typedef void Type(T0,T1,T2);
		};
 
		template<typename C  ,typename T0,typename T1,typename T2>
		struct Retriver<void(__thiscall C::*)(T0,T1,T2)const>
		{
			typedef void Type(T0,T1,T2);
		};
  
/***********************************************************************
vl::function_type_retriver::Retriver for R(T0,T1,T2,T3)
***********************************************************************/
		template<typename R,typename T0,typename T1,typename T2,typename T3>
		struct Retriver<R(*)(T0,T1,T2,T3)>
		{
			typedef R Type(T0,T1,T2,T3);
		};
 
		template<typename R,typename T0,typename T1,typename T2,typename T3>
		struct Retriver<Func<R(T0,T1,T2,T3)>>
		{
			typedef R Type(T0,T1,T2,T3);
		};
 
		template<typename C ,typename R,typename T0,typename T1,typename T2,typename T3>
		struct Retriver<R(__thiscall C::*)(T0,T1,T2,T3)>
		{
			typedef R Type(T0,T1,T2,T3);
		};
 
		template<typename C ,typename R,typename T0,typename T1,typename T2,typename T3>
		struct Retriver<R(__thiscall C::*)(T0,T1,T2,T3)const>
		{
			typedef R Type(T0,T1,T2,T3);
		};
 
/***********************************************************************
vl::function_type_retriver::Retriver for void(T0,T1,T2,T3)
***********************************************************************/
		template< typename T0,typename T1,typename T2,typename T3>
		struct Retriver<void(*)(T0,T1,T2,T3)>
		{
			typedef void Type(T0,T1,T2,T3);
		};
 
		template< typename T0,typename T1,typename T2,typename T3>
		struct Retriver<Func<void(T0,T1,T2,T3)>>
		{
			typedef void Type(T0,T1,T2,T3);
		};
 
		template<typename C  ,typename T0,typename T1,typename T2,typename T3>
		struct Retriver<void(__thiscall C::*)(T0,T1,T2,T3)>
		{
			typedef void Type(T0,T1,T2,T3);
		};
 
		template<typename C  ,typename T0,typename T1,typename T2,typename T3>
		struct Retriver<void(__thiscall C::*)(T0,T1,T2,T3)const>
		{
			typedef void Type(T0,T1,T2,T3);
		};
  
/***********************************************************************
vl::function_type_retriver::Retriver for R(T0,T1,T2,T3,T4)
***********************************************************************/
		template<typename R,typename T0,typename T1,typename T2,typename T3,typename T4>
		struct Retriver<R(*)(T0,T1,T2,T3,T4)>
		{
			typedef R Type(T0,T1,T2,T3,T4);
		};
 
		template<typename R,typename T0,typename T1,typename T2,typename T3,typename T4>
		struct Retriver<Func<R(T0,T1,T2,T3,T4)>>
		{
			typedef R Type(T0,T1,T2,T3,T4);
		};
 
		template<typename C ,typename R,typename T0,typename T1,typename T2,typename T3,typename T4>
		struct Retriver<R(__thiscall C::*)(T0,T1,T2,T3,T4)>
		{
			typedef R Type(T0,T1,T2,T3,T4);
		};
 
		template<typename C ,typename R,typename T0,typename T1,typename T2,typename T3,typename T4>
		struct Retriver<R(__thiscall C::*)(T0,T1,T2,T3,T4)const>
		{
			typedef R Type(T0,T1,T2,T3,T4);
		};
 
/***********************************************************************
vl::function_type_retriver::Retriver for void(T0,T1,T2,T3,T4)
***********************************************************************/
		template< typename T0,typename T1,typename T2,typename T3,typename T4>
		struct Retriver<void(*)(T0,T1,T2,T3,T4)>
		{
			typedef void Type(T0,T1,T2,T3,T4);
		};
 
		template< typename T0,typename T1,typename T2,typename T3,typename T4>
		struct Retriver<Func<void(T0,T1,T2,T3,T4)>>
		{
			typedef void Type(T0,T1,T2,T3,T4);
		};
 
		template<typename C  ,typename T0,typename T1,typename T2,typename T3,typename T4>
		struct Retriver<void(__thiscall C::*)(T0,T1,T2,T3,T4)>
		{
			typedef void Type(T0,T1,T2,T3,T4);
		};
 
		template<typename C  ,typename T0,typename T1,typename T2,typename T3,typename T4>
		struct Retriver<void(__thiscall C::*)(T0,T1,T2,T3,T4)const>
		{
			typedef void Type(T0,T1,T2,T3,T4);
		};
  
/***********************************************************************
vl::function_type_retriver::Retriver for R(T0,T1,T2,T3,T4,T5)
***********************************************************************/
		template<typename R,typename T0,typename T1,typename T2,typename T3,typename T4,typename T5>
		struct Retriver<R(*)(T0,T1,T2,T3,T4,T5)>
		{
			typedef R Type(T0,T1,T2,T3,T4,T5);
		};
 
		template<typename R,typename T0,typename T1,typename T2,typename T3,typename T4,typename T5>
		struct Retriver<Func<R(T0,T1,T2,T3,T4,T5)>>
		{
			typedef R Type(T0,T1,T2,T3,T4,T5);
		};
 
		template<typename C ,typename R,typename T0,typename T1,typename T2,typename T3,typename T4,typename T5>
		struct Retriver<R(__thiscall C::*)(T0,T1,T2,T3,T4,T5)>
		{
			typedef R Type(T0,T1,T2,T3,T4,T5);
		};
 
		template<typename C ,typename R,typename T0,typename T1,typename T2,typename T3,typename T4,typename T5>
		struct Retriver<R(__thiscall C::*)(T0,T1,T2,T3,T4,T5)const>
		{
			typedef R Type(T0,T1,T2,T3,T4,T5);
		};
 
/***********************************************************************
vl::function_type_retriver::Retriver for void(T0,T1,T2,T3,T4,T5)
***********************************************************************/
		template< typename T0,typename T1,typename T2,typename T3,typename T4,typename T5>
		struct Retriver<void(*)(T0,T1,T2,T3,T4,T5)>
		{
			typedef void Type(T0,T1,T2,T3,T4,T5);
		};
 
		template< typename T0,typename T1,typename T2,typename T3,typename T4,typename T5>
		struct Retriver<Func<void(T0,T1,T2,T3,T4,T5)>>
		{
			typedef void Type(T0,T1,T2,T3,T4,T5);
		};
 
		template<typename C  ,typename T0,typename T1,typename T2,typename T3,typename T4,typename T5>
		struct Retriver<void(__thiscall C::*)(T0,T1,T2,T3,T4,T5)>
		{
			typedef void Type(T0,T1,T2,T3,T4,T5);
		};
 
		template<typename C  ,typename T0,typename T1,typename T2,typename T3,typename T4,typename T5>
		struct Retriver<void(__thiscall C::*)(T0,T1,T2,T3,T4,T5)const>
		{
			typedef void Type(T0,T1,T2,T3,T4,T5);
		};
  
/***********************************************************************
vl::function_type_retriver::Retriver for R(T0,T1,T2,T3,T4,T5,T6)
***********************************************************************/
		template<typename R,typename T0,typename T1,typename T2,typename T3,typename T4,typename T5,typename T6>
		struct Retriver<R(*)(T0,T1,T2,T3,T4,T5,T6)>
		{
			typedef R Type(T0,T1,T2,T3,T4,T5,T6);
		};
 
		template<typename R,typename T0,typename T1,typename T2,typename T3,typename T4,typename T5,typename T6>
		struct Retriver<Func<R(T0,T1,T2,T3,T4,T5,T6)>>
		{
			typedef R Type(T0,T1,T2,T3,T4,T5,T6);
		};
 
		template<typename C ,typename R,typename T0,typename T1,typename T2,typename T3,typename T4,typename T5,typename T6>
		struct Retriver<R(__thiscall C::*)(T0,T1,T2,T3,T4,T5,T6)>
		{
			typedef R Type(T0,T1,T2,T3,T4,T5,T6);
		};
 
		template<typename C ,typename R,typename T0,typename T1,typename T2,typename T3,typename T4,typename T5,typename T6>
		struct Retriver<R(__thiscall C::*)(T0,T1,T2,T3,T4,T5,T6)const>
		{
			typedef R Type(T0,T1,T2,T3,T4,T5,T6);
		};
 
/***********************************************************************
vl::function_type_retriver::Retriver for void(T0,T1,T2,T3,T4,T5,T6)
***********************************************************************/
		template< typename T0,typename T1,typename T2,typename T3,typename T4,typename T5,typename T6>
		struct Retriver<void(*)(T0,T1,T2,T3,T4,T5,T6)>
		{
			typedef void Type(T0,T1,T2,T3,T4,T5,T6);
		};
 
		template< typename T0,typename T1,typename T2,typename T3,typename T4,typename T5,typename T6>
		struct Retriver<Func<void(T0,T1,T2,T3,T4,T5,T6)>>
		{
			typedef void Type(T0,T1,T2,T3,T4,T5,T6);
		};
 
		template<typename C  ,typename T0,typename T1,typename T2,typename T3,typename T4,typename T5,typename T6>
		struct Retriver<void(__thiscall C::*)(T0,T1,T2,T3,T4,T5,T6)>
		{
			typedef void Type(T0,T1,T2,T3,T4,T5,T6);
		};
 
		template<typename C  ,typename T0,typename T1,typename T2,typename T3,typename T4,typename T5,typename T6>
		struct Retriver<void(__thiscall C::*)(T0,T1,T2,T3,T4,T5,T6)const>
		{
			typedef void Type(T0,T1,T2,T3,T4,T5,T6);
		};
  
/***********************************************************************
vl::function_type_retriver::Retriver for R(T0,T1,T2,T3,T4,T5,T6,T7)
***********************************************************************/
		template<typename R,typename T0,typename T1,typename T2,typename T3,typename T4,typename T5,typename T6,typename T7>
		struct Retriver<R(*)(T0,T1,T2,T3,T4,T5,T6,T7)>
		{
			typedef R Type(T0,T1,T2,T3,T4,T5,T6,T7);
		};
 
		template<typename R,typename T0,typename T1,typename T2,typename T3,typename T4,typename T5,typename T6,typename T7>
		struct Retriver<Func<R(T0,T1,T2,T3,T4,T5,T6,T7)>>
		{
			typedef R Type(T0,T1,T2,T3,T4,T5,T6,T7);
		};
		...
		struct Retriver<R(__thiscall C::*)(T0,T1,T2,T3,T4,T5,T6,T7)>
		{
			typedef R Type(T0,T1,T2,T3,T4,T5,T6,T7);
		};
 
		template<typename C ,typename R,typename T0,typename T1,typename T2,typename T3,typename T4,typename T5,typename T6,typename T7>
		struct Retriver<R(__thiscall C::*)(T0,T1,T2,T3,T4,T5,T6,T7)const>
		{
			typedef R Type(T0,T1,T2,T3,T4,T5,T6,T7);
		};
 
/***********************************************************************
vl::function_type_retriver::Retriver for void(T0,T1,T2,T3,T4,T5,T6,T7)
***********************************************************************/
		template< typename T0,typename T1,typename T2,typename T3,typename T4,typename T5,typename T6,typename T7>
		struct Retriver<void(*)(T0,T1,T2,T3,T4,T5,T6,T7)>
		{
			typedef void Type(T0,T1,T2,T3,T4,T5,T6,T7);
		};
 
		template< typename T0,typename T1,typename T2,typename T3,typename T4,typename T5,typename T6,typename T7>
		struct Retriver<Func<void(T0,T1,T2,T3,T4,T5,T6,T7)>>
		{
			typedef void Type(T0,T1,T2,T3,T4,T5,T6,T7);
		};
 
		template<typename C  ,typename T0,typename T1,typename T2,typename T3,typename T4,typename T5,typename T6,typename T7>
		struct Retriver<void(__thiscall C::*)(T0,T1,T2,T3,T4,T5,T6,T7)>
		{
			typedef void Type(T0,T1,T2,T3,T4,T5,T6,T7);
		};
 
		template<typename C  ,typename T0,typename T1,typename T2,typename T3,typename T4,typename T5,typename T6,typename T7>
		struct Retriver<void(__thiscall C::*)(T0,T1,T2,T3,T4,T5,T6,T7)const>
		{
			typedef void Type(T0,T1,T2,T3,T4,T5,T6,T7);
		};
  
/***********************************************************************
vl::function_type_retriver::Retriver for R(T0,T1,T2,T3,T4,T5,T6,T7,T8)
***********************************************************************/
		template<typename R,typename T0,typename T1,typename T2,typename T3,typename T4,typename T5,typename T6,typename T7,typename T8>
		struct Retriver<R(*)(T0,T1,T2,T3,T4,T5,T6,T7,T8)>
		{
			typedef R Type(T0,T1,T2,T3,T4,T5,T6,T7,T8);
		};
 
		template<typename R,typename T0,typename T1,typename T2,typename T3,typename T4,typename T5,typename T6,typename T7,typename T8>
		struct Retriver<Func<R(T0,T1,T2,T3,T4,T5,T6,T7,T8)>>
		{
			typedef R Type(T0,T1,T2,T3,T4,T5,T6,T7,T8);
		};
		...
		struct Retriver<R(__thiscall C::*)(T0,T1,T2,T3,T4,T5,T6,T7,T8)>
		{
			typedef R Type(T0,T1,T2,T3,T4,T5,T6,T7,T8);
		};
 
		template<typename C ,typename R,typename T0,typename T1,typename T2,typename T3,typename T4,typename T5,typename T6,typename T7,typename T8>
		struct Retriver<R(__thiscall C::*)(T0,T1,T2,T3,T4,T5,T6,T7,T8)const>
		{
			typedef R Type(T0,T1,T2,T3,T4,T5,T6,T7,T8);
		};
 
/***********************************************************************
vl::function_type_retriver::Retriver for void(T0,T1,T2,T3,T4,T5,T6,T7,T8)
***********************************************************************/
		template< typename T0,typename T1,typename T2,typename T3,typename T4,typename T5,typename T6,typename T7,typename T8>
		struct Retriver<void(*)(T0,T1,T2,T3,T4,T5,T6,T7,T8)>
		{
			typedef void Type(T0,T1,T2,T3,T4,T5,T6,T7,T8);
		};
 
		template< typename T0,typename T1,typename T2,typename T3,typename T4,typename T5,typename T6,typename T7,typename T8>
		struct Retriver<Func<void(T0,T1,T2,T3,T4,T5,T6,T7,T8)>>
		{
			typedef void Type(T0,T1,T2,T3,T4,T5,T6,T7,T8);
		};
		...
		struct Retriver<void(__thiscall C::*)(T0,T1,T2,T3,T4,T5,T6,T7,T8)>
		{
			typedef void Type(T0,T1,T2,T3,T4,T5,T6,T7,T8);
		};
 
		template<typename C  ,typename T0,typename T1,typename T2,typename T3,typename T4,typename T5,typename T6,typename T7,typename T8>
		struct Retriver<void(__thiscall C::*)(T0,T1,T2,T3,T4,T5,T6,T7,T8)const>
		{
			typedef void Type(T0,T1,T2,T3,T4,T5,T6,T7,T8);
		};
  
/***********************************************************************
vl::function_type_retriver::Retriver for R(T0,T1,T2,T3,T4,T5,T6,T7,T8,T9)
***********************************************************************/
		template<typename R,typename T0,typename T1,typename T2,typename T3,typename T4,typename T5,typename T6,typename T7,typename T8,typename T9>
		struct Retriver<R(*)(T0,T1,T2,T3,T4,T5,T6,T7,T8,T9)>
		{
			typedef R Type(T0,T1,T2,T3,T4,T5,T6,T7,T8,T9);
		};
 
		template<typename R,typename T0,typename T1,typename T2,typename T3,typename T4,typename T5,typename T6,typename T7,typename T8,typename T9>
		struct Retriver<Func<R(T0,T1,T2,T3,T4,T5,T6,T7,T8,T9)>>
		{
			typedef R Type(T0,T1,T2,T3,T4,T5,T6,T7,T8,T9);
		};
		...
		struct Retriver<R(__thiscall C::*)(T0,T1,T2,T3,T4,T5,T6,T7,T8,T9)>
		{
			typedef R Type(T0,T1,T2,T3,T4,T5,T6,T7,T8,T9);
		};
 
		template<typename C ,typename R,typename T0,typename T1,typename T2,typename T3,typename T4,typename T5,typename T6,typename T7,typename T8,typename T9>
		struct Retriver<R(__thiscall C::*)(T0,T1,T2,T3,T4,T5,T6,T7,T8,T9)const>
		{
			typedef R Type(T0,T1,T2,T3,T4,T5,T6,T7,T8,T9);
		};
 
/***********************************************************************
vl::function_type_retriver::Retriver for void(T0,T1,T2,T3,T4,T5,T6,T7,T8,T9)
***********************************************************************/
		template< typename T0,typename T1,typename T2,typename T3,typename T4,typename T5,typename T6,typename T7,typename T8,typename T9>
		struct Retriver<void(*)(T0,T1,T2,T3,T4,T5,T6,T7,T8,T9)>
		{
			typedef void Type(T0,T1,T2,T3,T4,T5,T6,T7,T8,T9);
		};
 
		template< typename T0,typename T1,typename T2,typename T3,typename T4,typename T5,typename T6,typename T7,typename T8,typename T9>
		struct Retriver<Func<void(T0,T1,T2,T3,T4,T5,T6,T7,T8,T9)>>
		{
			typedef void Type(T0,T1,T2,T3,T4,T5,T6,T7,T8,T9);
		};
		...
		struct Retriver<void(__thiscall C::*)(T0,T1,T2,T3,T4,T5,T6,T7,T8,T9)>
		{
			typedef void Type(T0,T1,T2,T3,T4,T5,T6,T7,T8,T9);
		};
 
		template<typename C  ,typename T0,typename T1,typename T2,typename T3,typename T4,typename T5,typename T6,typename T7,typename T8,typename T9>
		struct Retriver<void(__thiscall C::*)(T0,T1,T2,T3,T4,T5,T6,T7,T8,T9)const>
		{
			typedef void Type(T0,T1,T2,T3,T4,T5,T6,T7,T8,T9);
		};
